...
<head>
    ...
    <style>
        ...
        .container {
            position: relative;
            overflow: hidden;
            /* Mencegah elemen keluar dari container */
        }
...
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm box-shadow-bottom" style="height: 15vh;">
        <div class="container d-flex align-items-center justify-content-between">
            <img src="assets/landing/landing-nav.png" alt="" width="80px" height="70px">

            <!-- Tombol "Masuk" tetap terlihat di mobile -->
            <a class="btn text-center d-lg-none" href="login"
                style="font-size: 14px; font-weight: 700; color: #006041; width: 150px; height: 40px; 
